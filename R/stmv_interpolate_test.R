stmv_interpolate_test = function(p, runmode="default", global_sppoly=NULL ) {
  ...
  for ( iip in ip ) {
    ...
    pa = try( stmv_predictionarea( p=p, sloc=sloc, windowsize.half=windowsize.half, runmode=runmode, global_sppoly=global_sppoly ) )
