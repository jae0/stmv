  ...
  emei_map = function( xyz, cfa.regions=T, depthcontours=T, pts=NULL, colpts=F, annot=NULL, annot.cex=2.2,
    ...
    lp = levelplot( z ~ plon+plat, data=xyz, aspect="iso", pts=pts, colpts=colpts, annot=annot, spatial.domain=spatial.domain,
      ...
      panel = function(x, y, z, rez=rez,  ...) {
        ...
        #coastline
        coast = emgis::coastline.db(p=pp, crs=pp$internal.crs, DS="gshhg coastline highres" )
