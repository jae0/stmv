...
stmv = function( p, runmode="interpolate", DATA=NULL,
 ...
 # data coordinates
  ...
  if ("interpolate" %in% runmode ) {
    ...
    # do it again, but with more permissive lower bound of p$n.min and large distance bounds
    p$n.min = p$n.min * 2
    p$stmv_distance_scale = p$stmv_distance_scale*2
    p$stmv_distance_max = p$stmv_distance_max *2
