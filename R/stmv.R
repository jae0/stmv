...
stmv = function( p, runmode=NULL, DATA=NULL, nlogs=100, niter=1,
  ...
  if (is.null(runmode)) {
    ...
    runmode = intersect(s_runmode, c( "globalmodel", "scale", "interpolate_fast_predictions", "interpolate", "interpolate_distance_basis", "interpolate_force_complete", "save_completed_data", "restart_load") )
  }
