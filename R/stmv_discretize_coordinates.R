stmv_discretize_coordinates = function(coords, z=NULL, discretized_n=100, minresolution=NULL, coord_is_time=FALSE, ti.offset=NULL, ti.min=NULL, FUNC=mean, method="default", ...) {
  ...
  if (ncoords==1) {
    ...
    if (coord_is_time) {
      ...
      coords = floor( coords  / minresolution ) * minresolution
