...
stm_LaplacesDemon_spate = function( Model, Data, Initial.Values, Covar=NULL, Iterations=1000, 
    ...
    LDspecs = stm_LaplacesDemon_Specification( Algorithm=Algorithm, LogFile=LogFile, Specs=Specs, LIV=LIV, Covar=Covar, ScaleF=ScaleF )
