  ...
  stmv__fft__original = function( p=NULL, dat=NULL, pa=NULL, nu=NULL, phi=NULL, variablelist=FALSE, eps=1e-9, ... ) {

    #\\ NOTE: higher RAM requirements than the current stmv__ftt
