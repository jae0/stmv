...
# NOTE storage of stmv outputs are  in p$stmvSaveDir = file.path( p$modeldir, p$stmv_model_label, p$project_class, paste(  p$stmv_global_modelengine, stmv_local_modelengine, sep="_"), p$stmv_variables$Y, p$spatial_domain)
...
p = bio.snowcrab::snowcrab_parameters(
  ...
  stmv_distance_scale = c(50, 60, 80)
)
...
p = snowcrab_parameters( p=p, project_class="stmv",
